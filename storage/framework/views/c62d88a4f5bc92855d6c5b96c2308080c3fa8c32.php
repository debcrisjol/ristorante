    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="#"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline"> <i class="fa-solid fa-martini-glass-citrus"> </i> <i class="fa-solid fa-pizza-slice"></i> <i class="fa-solid fa-utensils"></i> <i class="fa-solid fa-spoon"></i> <i class="fa-solid fa-hand-holding-heart"></i> <i class="fa-solid fa-cheese"></i> <i class="fa-solid fa-cake-candles"></i> <br/>
                     <span class="text-red-500 mx-5">Resto-Admin</span> </a>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin-nav-link','data' => ['href' => route('admin.categories.index'),'active' => request()->routeIs('admin.categories.index')]]); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin-nav-link','data' => ['href' => route('admin.menus.index'),'active' => request()->routeIs('admin.menus.index')]]); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin-nav-link','data' => ['href' => route('admin.tables.index'),'active' => request()->routeIs('admin.tables.index')]]); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin-nav-link','data' => ['href' => route('admin.reservations.index'),'active' => request()->routeIs('admin.reservations.index')]]); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php /**PATH C:\Users\debcr\ristorante\resources\views/layouts/admin.blade.php ENDPATH**/ ?>